...
This directory is for the code of the _server B_. A starter Dockerfile has been added.
...
To get started,
 you should run `npm init` in this directory to initialize the Node project. This will create a `package.json`-file, which is used to define the project's attributes, dependencies etc. You should next create the index.js file.
