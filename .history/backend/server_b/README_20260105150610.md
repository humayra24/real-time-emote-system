...
Server B consumes the _raw-emote-data_ topic and produces the _aggregated-emote-data_ topic. It also expose a REST API for managing aggregation settings.
